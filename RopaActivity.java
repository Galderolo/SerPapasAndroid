...
public class RopaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vacioText = findViewById(R.id.textVacioRopa);
        vacioIco = findViewById(R.id.icoVacioRopa);
        vacioBtn = findViewById(R.id.btnVacioRopa);
        setInvisibleText();
        UpdateLista();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.addMenu_eliminar: {
                EliminarBD delete = new EliminarBD(this, Util.CATEGORIA_ROPA, true);
    ...
    public void setBarraAccion () {
        ...
        getSupportActionBar().setTitle("Su Ropa");
        getSupportActionBar().setSubtitle("Todo lo que ya tengo");
    }

    public static void UpdateLista() {
        if(context != null) {
            Adaptador ad = new Adaptador(context, Util.CATEGORIA_ROPA);
            lista.setAdapter(ad);
        }
    }
