 ...
 */
public class FragmentDeporte2 extends Fragment {

    private static final String TAG = "Deporte2";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_embarazo_deporte_tab2, container, false);
