...
public class ComerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista = (ListView)findViewById(R.id.listaComer);
        vacioText = findViewById(R.id.textVacioComer);
        vacioIco = findViewById(R.id.icoVacioComer);
        vacioBtn = findViewById(R.id.btnVacioComer);
        setInvisibleText();
        UpdateLista();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.addMenu_eliminar: {
                EliminarBD delete = new EliminarBD(this, Util.CATEGORIA_COMIDA, true);
    ...
    public static void UpdateLista () {
        if(context != null) {
            Adaptador ad = new Adaptador(context, Util.CATEGORIA_COMIDA);
            lista.setAdapter(ad);
        }
    }
    ...
    public void setBarraAccion () {
        ...
        getSupportActionBar().setTitle("Para la Comida");
